...
const Fifth = () => {
  return (
    <div className="w-full p-4 h-full mt-12 gap-2 justify-evenly items-center flex flex-row ">
    
      <div className='flex   items-center  justify-evenly  w-[40%] h-[90%]  '>
      <img className=' object-cover w-[80%] h-[50%] mr-12 ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHi9YdJIxQnrolOvvnTnn8VmUuJCv9ZqwTPA&usqp=CAU" alt="" />
      </div> 
      <div className='flex  ml-8      mt-7 justify-center flex-col w-[40%] h-[90%]  '>
      ...
      <button type="button" class="py-2.5 px-2 mr-3 w-[20%] mb-2 mt-3 text-lg font-sm text-white focus:outline-none bg-green-600  rounded-sm flex flex-row border border-green-600 hover:bg-gray-100 hover:text-green-600 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Learn More

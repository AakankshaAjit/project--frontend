...
<span className='text-[19px] font-bold'>Membership </span>
<span className='text-[19px] font-bold'> organizations</span>
<span className='text-[12px] font-medium'>our membership manageme</span>
<span className='text-[12px] font-medium'> software provides full automation of </span>
<span className='text-[12px] font-medium'>  membership renewals and payments</span>
...
<span className='text-[19px] font-bold'>National </span>
<span className='text-[19px] font-bold'> Associations</span>
<span className='text-[12px] font-medium'>our membership manageme</span>
<span className='text-[12px] font-medium'> software provides full automation of </span>
<span className='text-[12px] font-medium'>  membership renewals and payments</span>
...
<span className='text-[19px] font-bold'>Cluba And </span>
<span className='text-[19px] font-bold'> Groups</span>
<span className='text-[12px] font-medium'>our membership manageme</span>
<span className='text-[12px] font-medium'> software provides full automation of </span>
<span className='text-[12px] font-medium'>  membership renewals and payments</span>
